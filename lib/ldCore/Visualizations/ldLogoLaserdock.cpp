...
LogoPoint::LogoPoint(float _x, float _y) {
    x = _x; y = _y;
}
...
void Logo::render(ldRendererOpenlase *m_renderer) {
    ...
    for(const LogoLine &line : lines) {
        ...
        for (int i = istart; i <= iend; i++) {
            const LogoPoint &r = line.points[i];
...
LogoLaserdock::LogoLaserdock() {
    ...
    {
        LogoLine l;
        l.points.append(LogoPoint(1402,532));
        l.points.append(LogoPoint(1068,1120));
        l.points.append(LogoPoint(1369,1120));
        l.points.append(LogoPoint(1414,1046));
        l.points.append(LogoPoint(1201,1046));
        l.points.append(LogoPoint(1446,616));
    ...
    {
        LogoLine l;
        l.points.append(LogoPoint(1460,643));
        l.points.append(LogoPoint(1417,716));
        l.points.append(LogoPoint(1608,1046));
        l.points.append(LogoPoint(1442,1046));
        l.points.append(LogoPoint(1402,1120));
        l.points.append(LogoPoint(1736,1120));
