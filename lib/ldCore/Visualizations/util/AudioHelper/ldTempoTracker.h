...
#include <aubio/src/mathutils.h>
#include <aubio/src/tempo/beattracking.h>
#include <aubio/src/tempo/tempo.h>

#include <ldCore/Sound/ldSoundData.h>

class LDCORESHARED_EXPORT TempoTracker {

public:

    explicit TempoTracker(char* _algorithm = (char*)"default", bool _fastBeats = true, bool _allowPartialBeats = true, float _newBeatConfidenceCutoff = 0);
    virtual ~TempoTracker();
