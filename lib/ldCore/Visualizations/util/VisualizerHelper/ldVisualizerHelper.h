...
class LDCORESHARED_EXPORT BeatSignal {
public:
    float value;// = 0;
    float mult;// = 1.55;
    float floor;// = 0.1;
...
class LDCORESHARED_EXPORT StatValue {
public:
...
class LDCORESHARED_EXPORT PresetSignal {
public:
    StatValue stat;
    float statOutput;
    BeatSignal signal;
    ...
    PresetSignal (/*float statTime = 0.5, float statType = 0.5, float statScale = 0.5,
...
class LDCORESHARED_EXPORT MusicReactor
{
