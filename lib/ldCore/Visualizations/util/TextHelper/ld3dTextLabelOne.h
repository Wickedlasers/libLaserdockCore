...
#include "ldCore/Visualizations/util/DrawHelper/ld3dBezierCurveDrawer.h"
...
{
public:
    explicit ld3dTextLabelOne(const std::string& p_string = "", float p_fontSize = 1.0f/16);
    ~ld3dTextLabelOne();

    virtual void setText(const std::string& p_string) override;
