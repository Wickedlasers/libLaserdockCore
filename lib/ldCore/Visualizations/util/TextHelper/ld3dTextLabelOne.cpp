...
// ld3dTextLabelOne
ld3dTextLabelOne::ld3dTextLabelOne(const std::string& p_string, float p_fontSize)
    : ldAbstractText()
...
// setText
void ld3dTextLabelOne::setText(const std::string &p_string)
{
    m_string = p_string;
    ...
    //
    QString qString(p_string.c_str());
...
void ld3dTextLabelOne::updateCurrentString()
{
    ...
    std::string currentWord = _words[_currentIndice].toStdString();

    initLabelLettersFrame(currentWord);
